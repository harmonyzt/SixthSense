...
namespace SixthSense.Logic
{
    public static class SixthSenseAlert
    {
        private static SixthSenseAlertComponent _alertInstance;
        private static float _lastTriggerTime = -999f; // this should always trigger the sound for the first time
        ...
        public static async Task Trigger()
        {
            ...
            float cooldown = Plugin.AlertCooldown.Value;
